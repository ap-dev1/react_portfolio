...
export default function AgentHooks(props) {
    ...
    useEffect(() => {
        if (paused === false) {
            let idx = d3.randomUniform(0, etbdState.popSize - 1)()
            setemsidx(idx)
            setems(ppl[idx])
        }
    },
    ...
    useEffect(() => {
        if (paused === false) {
            let gendata = { g: g, ppl: ppl, ems: ems, cls: cls, rnf: rnf, co: co };
    ...
    //  etbdEvents has been updated. 
    // Update the charts based on this data, unsliced:
                ...
                <div className='agent-theory'>
                    ...
                    <div className='agent' title='Agent'>
                        ...
                        >
                            ...
                            <button
                                style={{
                                    backgroundColor: (prevgen.current && prevgen.current.cls === 'class1') ? etbdState.color11 : etbdState.color22
                                }}
                            >
                                {prevgen.current ? prevgen.current.ems : "prevgen"}
                            </button>
                            ...
                            >
                                {prevgen.current ? `${prevgen.current.g - g} gen ago` : "-"}
                            </button>
                        </div>
                                ...
                                ppl.map((item, i) => {
                                    return (
                                        <button
                                            ...
                                            // name={`${i}`}
                                            style={{
                                                transform: item === ems ? `translateY(-20px)` : `translateY(0px)`,
                                            }}
                                        >
                                            {item}
                                        </button>
                        ...
                        <div className="div-ems-rnf">

                            <button
                                className='btn-ems'
                                style={{
                                    // backgroundColor: cls === 'class1' ? etbdState.color111 : (cls === 'class2' ? etbdState.color222 : 'transparent'),

                                    border: cls === 'class1' ? `1px solid ${etbdState.color111}` : (cls === 'class2' ? `1px solid ${etbdState.color222}` : '0px solid transparent')
                                }}
                            >
                                {ems}
                            </button>
                    ...
                    <div className='evd'>
                        <div className='box-title'>
                            <h7>Evolutionary <br />principles</h7>
