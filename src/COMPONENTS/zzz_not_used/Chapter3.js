    ...
    render() {
        ...
        return (
            <div id="ch3"
                className="chapter"
                style={{
                    //backgroundColor: "#09868b",  NICE, WORKS
            ...
            >
                ...
                3. When did you finish becoming you? Do you remember?
                        ...
                        <h1 className="chapter-title">
                            Emergence, learning, and development
            </h1>
                ...
                A question not for the faint of heart (McDowell & Klapes, 2019).
                        ...
                        <p className="p-left">
                            In parallel, I made progress on the human development front.  </p> */}
              ...
              computational theory of behavior dynamics.
                    ...
                    <div className="chapterCol">
                        ...
                        <ReadMoreHook
                            maxChars={500}
                            overview={parse("During my appointment at Agnes Scott (2015-2016) my mentees and I explored concurrent schedules of reinforcement and punishment, escape behavior, extinction-induced phenomena, invisible target classes of different dimensions, etc.")}
                        /> */}

                        {/* <h2 className="chapter-sub-title">Approach and Avoidance in a symmetrical experiment</h2>
                        <ReadMoreHook
                            maxChars={500}
                            overview={parse("At Oxford, in 2017-2018, I led a research study on the difference between positive reinforcement and avoidance - a symmetrical comparison on their effects on learning arbitrary rules. Point-Acquisition events were twice as effective than the avoidance of Point-Loss events, between and within particpants, with Fixed and Variable Intervals, and with signalled and unsignalled contingencies.")}/> */}



                        <h2 className="chapter-sub-title">Recreate this, Jack!</h2>
                        <ReadMoreHook
                            maxChars={500}
                            overview={parse(
