...
var infoTimeline = [
    ...
    {id: 3, title: 'Wolfram, Complexity, and a New Kind of Science', date: "07/01/2009",
        ...
        // description: "An exploration of complexity and emergence, and their relevance to behavior analysis; created cumulative records, prepare inter-response time (IRT) distributions,        and calculate average response rates from the outputs of cellular automata. <br/><br/> fig 5 from  Behavioural Processes 81 (2009) 343–352 <br/><br/> Fig. 5. Image of a section of cellular automaton output, a cumulative record, and a log IRT survivor plot for a Rule 22 (top row) and a Rule 30 (bottom row) cellular automaton. The cumulative records and log survivor plots were constructed from a column of the cellular automaton output where each black cell was taken to represent a response.",

        description:  "<b>4. Applying cellular automata to behavior (p. 348)</b> <br/><br/> <i>Cellular automata have been used to represent and understand ballistic collisions in particle mechanics, turbulence in fluid flow, the flow of automobile traffic, and the Belousov–Zhabotinsky reaction, which is a non-linear chemical oscillation. Using cellular automata to represent natural phenomena such as these entails mapping features of the output of the machines onto physical properties of the phenomena. In the case of behavior, one possible mapping is to consider each column of the output of a cellular automaton as a series of time ticks (which it is) during which a discrete behavior, such as a lever press, may occur. Some pattern of cells, the simplest being a single black or white cell, can represent an occurrence of the behavior. Successive columns in the output of a cellular automaton may be taken to represent the continuation of an experimental session, or additional sessions, or sessions with different subjects. Given this mapping it is possible to create cumulative records, prepare inter-response time (IRT) distributions, and calculate average response rates from the outputs of cellular automata.<i/>",

        img: [paper_wolfram_fig5],
        urls: [
    ...
    {id: 16, title: 'Complexity, Darwinism, and the Emergence of High-Level Phenotypes',  date: "12/24/2013", 
        ...
        img: [ phd_committee , etbd_adhd_slide_1, phd_etbd_humans_1, phd_etbd_humans_2],
        urls: [
    ...
    {id: 17, title: 'Multifinality and Equifinality in ETBD',  date: "05/24/2014", 
        ...
        img: [ABAI_2014_Chicago, ABAI_2014_Andrei, abai_2014_slide1, abai_2014_slide2, ],
    ...
    {id: 19, title: 'Population Thinking, Psychodiversity, and Human Development', date: "02/09/2016", 
        ...
        tags: [],
        description: "",
        img: [darwin_2016_slide_03, darwin_2016_slide_04, darwin_2016_slide_06, darwin_2016_slide_07, darwin_2016_slide_08,  Darwin_2016],
        urls: [
            //{ name: "", link: "" },
         ],
    ...
    {id: 20, title: 'Behavioral Variability in ETBD', date: "03/01/2016",
        ...
        img: [paper_mcdowell_popa_2010_fig, paper_popa_mcdowell_2016_end, paper_popa_mcdowell_2016_etbd_humans, paper_popa_mcdowell_2016_fig9],
        urls: [
    ...
    {id: 23, title: 'Towards a Dynamic Account of Human Development',  date: "05/28/2017",
        ...
        { name: "Conference schedule", link: "https://www.abainternational.org/events/annual-2017.aspx" }
    ],
    ...
    {id: 28, title: 'The Shape of Will', date: "09/08/2019",
        type: 'preprint',
        time: "09/08/2019",
        role: "PRINCIPAL INVESTIGATOR",
        keywords: [],
    ...
    {id: 29, title: 'Card Sorting project', date: "10/2020",
        type: 'MERN app',
        time: "10/01/2020",
        role: "",
        keywords: [],
        tags: ["React", "Node/Express", "MongoDB/Atlas", "DynamoDB", "RDS/Postgres"],
        description: 'My first MERN app. Before switching to MongoDB/Atlas, I used DynamoDB for authentication and RDS for storing user data.',
