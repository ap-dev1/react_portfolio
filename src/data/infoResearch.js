...
var infoResearch = [
...

    {
        ...
        level: 2,
        content: "We explored the effects of reinforcement type on learning and on the neuronal activity that subserves learning (we recorded EEG data while students were engaged in operant behavior);  - we found that participants discovered abstract rules twice as fast when correct responses resulted in gaining points (positive reinforcement) then when they resulted in not losing points (negative reinforcement);",
    },
